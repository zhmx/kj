...
local protoMap = {
	NotifyAccess = {proto = "NotifyAccess", logic = require("game.thread"), session = GetSession(sprotoStr, "NotifyAccess")},
	ThreadLogin = {proto = "ThreadLogin", logic = require("game.thread"), session = GetSession(sprotoStr, "ThreadLogin")},
	ThreadLoginResponse = {proto = "ThreadLoginResponse", logic = require("game.thread"), session = GetSession(sprotoStr, "ThreadLoginResponse")},
	Ping = {proto = "Ping", logic = require("game.thread"), session = GetSession(sprotoStr, "Ping")},
	PingResponse = {proto = "PingResponse", logic = require("game.thread"), session = GetSession(sprotoStr, "PingResponse")},

	LoginGame = {proto = "LoginGame", logic = require("game.login"), session = GetSession(sprotoStr, "LoginGame")},
	CreateRole = {proto = "CreateRole", logic = require("game.login"), session = GetSession(sprotoStr, "CreateRole")},
	GetInfo = {proto = "GetInfo", logic = require("game.login"), session = GetSession(sprotoStr, "GetInfo")},
};
